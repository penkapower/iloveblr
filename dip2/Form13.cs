...
namespace dip2
{
    public partial class Form13 : Form
    {
        ...
        public Form13()
        {
            ...
            for (int i=1; i <= Convert.ToInt32(new DirectoryInfo("files/translate/q/").GetFiles().Length.ToString()); i++)
            {
                comboBox1.Items.Add(Path.GetFileName("files/translate/q/" + i));
            }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.Text = File.ReadAllText("files/translate/q/" + comboBox1.SelectedItem + ".txt", Encoding.Default);
                richTextBox1.Text = File.ReadAllText("files/translate/a/" + comboBox1.SelectedItem + ".txt", Encoding.Default);
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            {
                File.WriteAllText("files/translate/q/" + comboBox1.SelectedItem + ".txt", richTextBox2.Text, Encoding.Default);
                File.WriteAllText("files/translate/a/" + comboBox1.SelectedItem + ".txt", richTextBox1.Text, Encoding.Default);
        ...
        private void pictureBox10_Click(object sender, EventArgs e)
        {
            ...
            {
                File.WriteAllText("files/translate/q/" + (comboBox1.Items.Count + 1) + ".txt", richTextBox2.Text, Encoding.Default);
                File.WriteAllText("files/translate/a/" + (comboBox1.Items.Count + 1) + ".txt", richTextBox1.Text, Encoding.Default);
        ...
        private void pictureBox13_Click(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(comboBox1.SelectedItem) >= comboBox1.Items.Count)
            {
                ...
                {
                    File.Delete("files/translate/q/" + comboBox1.SelectedItem + ".txt");
                    File.Delete("files/translate/a/" + comboBox1.SelectedItem + ".txt");
                    richTextBox1.Text = "";
                    richTextBox2.Text = "";
